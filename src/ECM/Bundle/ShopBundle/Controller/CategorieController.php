...
use ECM\Bundle\ShopBundle\Entity\Categorie;
use ECM\Bundle\ShopBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ECMShopBundle:Categorie')->findAll();

        return $this->render('ECMShopBundle:Categorie:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ECMShopBundle:Categorie:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ECMShopBundle:Categorie')->find($id);
        ...
        return $this->render('ECMShopBundle:Categorie:show.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ECMShopBundle:Categorie:edit.html.twig', array(
            'entity' => $entity,
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $pR = $em->getRepository("ECMShopBundle:Produit");
        $cR = $em->getRepository("ECMShopBundle:Categorie");
        $categorie = $cR->find($id);
        $entites = $pR->findBy(array("categorie" => $categorie));
        return $this->render("ECMShopBundle:Shop:index.html.twig", array('entities' => $entites));
    }
}
